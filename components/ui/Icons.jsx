// Inline SVG icons. Decorative by default (aria-hidden); the parent
// link or button provides the accessible name.

function StrokeIcon({ className = "size-5", children }) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
...
export function DevicesIcon({ className }) {
  return (
    <StrokeIcon className={className}>
      ...
      <path d="M6 19h6" />
      <rect x="15" y="9" width="7" height="12" rx="1.5" />
    </StrokeIcon>
  );
}
